    ...
    <div className="min-h-screen bg-gradient-to-br from-navy-50 to-slate-100 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-display text-navy-900">Welcome Back</CardTitle>
          <p className="text-slate-600">Sign in to your EduMarket account</p>
        </CardHeader>
        <CardContent className="space-y-6">
          <form className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/auth/forgot-password" className="text-sm text-navy-600 hover:text-navy-800">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="text-center text-sm">
            ...
            <Link href="/auth/signup" className="text-navy-600 hover:text-navy-800 font-medium">
              Sign up
            </Link>
          </div>
        </CardContent>
